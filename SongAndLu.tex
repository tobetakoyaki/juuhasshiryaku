...
\begin{flushright}
	文責　ト部蛸焼\par
	第一版　\rensuji{2019}年\rensuji{2}月\rensuji{24}日\par
	第二版　\rensuji{2019}年\rensuji{2}月\rensuji{25}日
\end{flushright}
\vspace{\baselineskip}]
...
{\footnotesize
\noindent\textgt{問一}\quad いへども・もし（\rensuji{3}点$\times$\rensuji{2}\quad\rensuji{6}点）\par
\noindent\textgt{問二}\quad 商・楚人・宋人（\rensuji{3}点$\times$\rensuji{3}\quad\rensuji{9}点）\par
\noindent\textgt{問三}\quad 敵軍がまだ陣形を整えないうちに、攻撃すべきこと。（\rensuji{8}点）\par
\noindent\textgt{問四}\quad ロ（\rensuji{6}点）\par
\noindent\textgt{問五}\quad ニ（\rensuji{6}点）\par
\noindent\textgt{問六}\quad 戦いとは敵を殺すものであるから、
傷ついた敵兵でも追い討ちをかけるべきで、
それがいやなら初めから傷つけない方がよい。（\rensuji{15}点）\par
}
